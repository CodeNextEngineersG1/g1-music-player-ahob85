...
function updatePlayback(song) {
  nowPlayingTitle.innerHTML = song.title;    // the title of the song
  nowPlayingArtist.innerHTML = song.artist;   // the artist of the song
  nowPlayingImg.src = song.imgLocation;            // the image location of the song
}
